...
const GitHubAuth: React.FC<GitHubAuthProps> = ({ onAuthSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4 transition-colors">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-8 relative transition-colors">
        {/* Header */}
        <div className="text-center mb-4">
          <h1 className="text-sm text-gray-500 dark:text-gray-400 transition-colors">BaseBase Editor</h1>
        </div>

        {/* Modal content */}
        <div className="text-center">
          <div className="w-16 h-16 bg-gradient-to-r from-brand-700 to-brand-900 rounded-full mx-auto flex items-center justify-center mb-6">
          ...
          {error && (
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-4 py-3 rounded mb-4 transition-colors">
              {error}
            </div>
          )}
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-gradient-to-r from-brand-600 to-brand-800 hover:from-brand-700 hover:to-brand-900 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:transform-none disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 font-semibold py-2 px-6 rounded-lg transition-all duration-200 text-sm"
            >
              Create New Token on GitHub
            </button>
          </div>

          <div className="mt-6 text-xs text-gray-500 dark:text-gray-400 transition-colors">
